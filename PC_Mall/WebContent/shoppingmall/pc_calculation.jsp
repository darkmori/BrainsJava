...
<BODY leftmargin=0 topmargin=0 marginwidth=0 marginheight=0>
	...
	<table border=1 width=550 height=30 bordercolor=black>
		<tr>
			<td align=center bgcolor=0063ce><font color=white><b>조립
						PC 견적</b></td>
		</tr>
	</table>
	<br>
	...
	<form name="buy" action="../product/basket_insert.jsp" method="post">
		<table align=center border=0 cellpadding=0 cellspacing=3 width=550>
			<tr>
				<td bgcolor="#7eaee9" align="center"><b><font
						color="#ffffff">구분</font></b></td>
				<td bgcolor="#7eaee9" align="center"><b><font
						color="#ffffff">상품명</font></b></td>
			</tr>
			<%
			...
			%>
			<tr bgcolor=cde6ff>
				<td width=100><font color=black>&nbsp;<%=name%></font></td>
				<td><select name=productnum>
						<option value='0'>------------ 원하시는 부품을 목록에서 선택 하세요
							------------</option>
						<%
			...
			<tr>
				...
				<input type="submit" value="장바구니에 담기"></td>
			</tr>
		</table>
	</form>
