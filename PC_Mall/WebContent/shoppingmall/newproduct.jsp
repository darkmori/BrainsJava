...
<BODY leftmargin='0' topmargin='0' marginwidth='0' marginheight='0'>
	...
	<table border=1 width=500 height=30>
		<tr>
			<td align=center bgcolor=0063ce><font size=2 color=white><b>신
						상 품</b></td>
		</tr>
	</table>
	<br>
	<table width="500" border=0 cellpadding=1 cellspacing=1>
		<%
			try {
				...
				ResultSet rs = stmt.executeQuery(
						"select id,name,price,company_id,expression,photo from product order by cdate desc, id desc");
		...
		<tr>
			<td>
				<!-- ========= 왼쪽 테이블 ========== -->
				<table width="250" border=1 cellpadding=1 cellspacing=2 align=center
					bordercolor=#990000>
					<tr>
					...
					<tr>
						...
						<td bgcolor=cde6ff><c:set var="fmtPrice" value="<%=price%>" /> 
							<font>&nbsp;<fmt:formatNumber value="${fmtPrice }"
											pattern="#,###" />&nbsp;원
							</font>
