...
<BODY leftmargin='0' topmargin='0' marginwidth='0' marginheight='0'>
	...
	<center>
		...
		<table border=1 width=550 height=25 bordercolor=black>
			<tr>
				<td align=center bgcolor=0063ce><font size=2 color=white><b>공
							동 구 매</b></td>
			</tr>
		</table>
		<br>
		...
		<table border=1 width=270 height=40 bgcolor=#CCFFFF>
			<tr>
				<td><font size=2>&nbsp;입금기간 : 주문일로부터 2일이내 <br>&nbsp;배송기간
						: 결제확인 후 3일이내
				</font><br></td>
			</tr>
		</table>
			...
			<%
				try {
					...
					ResultSet rs = stmt.executeQuery(
							"select id,name,company_id,price,coo_price,quantity, coo_quantity,content,to_date(deadline,'yy-mm-dd'),photo from coo_product");
					...
					<table width=200 border=1 cellpadding=1 cellspacing=2>
						...
						<tr>
							<td colspan=2 align=center><a
								href="gongdong_view.jsp?bid=<%=id%>"><img
									src="../productimg/<%=photo%>" width=100 height=100 border=0>
							</a></td>
						</tr>
						<tr>
