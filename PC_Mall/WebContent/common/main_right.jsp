...
<table align=left border=1 width=450 cellpadding=0 cellspacing=0
	bgcolor=#ffffff>
	<tr>
		<td><table align=center border=0 width=450 cellpadding=0
				cellspacing=0 bgcolor=#ffffff>
				<div align=left>
					<img src="../img/bg-img1.gif" width=450 height=121>
				</div>
			</table></td>
	</tr>
	<!-- 최신상품 출력  -->
							...
							<tr>
								<td colspan=2 align=center><a
									href="../product/product.jsp?i=<%=id%>"> <img
										src="../product/image/<%=photo%>" width=90 height=90
										border=0></a></td>
							</tr>
							<tr>
	...
	<tr>
 	...
 	try {
 		...
 		rs1 = stmt1.executeQuery(
 				"select qnaid,title,name,to_char(cdate,'yy-mm-dd') from qna where type='I' order by 1 desc");
 %>
			<table border=0 cellpadding=0 cellspacing=0>
				<tr>
					<div align=left>
						<td bgcolor=white><img src="../img/title_qna.gif">
					</div>
					</td>
					<td colspan=2 align=right><a
						href="../board/qnashow.jsp?qnaid=1"><font color=blue>More...&nbsp;&nbsp;&nbsp;</font></a></b></td>
				</tr>
				<tr>
				...
				%>
				<tr height=21>
					<td align=left>&nbsp;<img src="../img/que.gif"> <a
						href="javascript:readContents('<%=rs1.getInt(1)%>')"><%=rs1.getString(2)%></a></td>
				...
				<%
					stmt = con.createStatement();
							rs = stmt.executeQuery(
									"select qnaid,title,name,to_char(cdate,'yy-mm-dd') from qna where type='R' and p_id ="
											+ rs1.getInt(1) + " order by 1 desc");
							while (rs.next()) {
				%>
				<tr height=21>
					<td align=left><img src="../img/answ.gif"> <a
						href="javascript:readContents('<%=rs.getInt(1)%>')"><%=rs.getString(2)%></a></td>
...
<td valign=top width=180>
	...
	<table border=0 cellPadding=0 cellSpacing=0 width=170>
		...
		<tr>
			...
			<font class="P9" color=red>&nbsp;[<fmt:formatNumber	value="${fmtPrice}" pattern="#,###" />&nbsp;원]
			</font>
