...
%>
	<center>
		<font color=red><%= s_word %></font> 에 대한 <font color=red><%= count %></font>
		개의 제품 검색결과 입니다!<br>
		<%
		}
%>
		<table width=550 border=0 cellpadding=0 cellspacing=0 bgcolor=ffffff>
			<tr>
				<td align=center bgcolor=#0000ff height=25><font color=#ffffff><b>제품
							카테고리</b></font></td>
			</tr>
			<tr>
				<td height=5></td>
...
%>
			<tr bgcolor="edf5fe">
				<td align=center><img border=0 name=PicMedium height=30
					width=30 src="../product/image/<%=photo%>"></td>
				<td height=30>&nbsp;&nbsp;&nbsp;&nbsp;<a
					href="../product/product.jsp?i=<%= id%>"> <%=name%></a></td>
				<td height=30>&nbsp;&nbsp;&nbsp;&nbsp;<%=price%>원
				</td>
			</tr>
			<%	
			}
