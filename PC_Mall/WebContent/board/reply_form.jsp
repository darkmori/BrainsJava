...
<BODY leftmargin='0' topmargin='0' marginwidth='0' marginheight='0'>
	...
	<table border=1 width=550 height=30 bordercolor=black>
		<tr>
			<td align=center bgcolor=0063ce><font size=3 color=#FFFFFF><b>게시물
						답변</b></td>
		</tr>
	</table>
	<br>
	...
	<table width="550" border="1" cellspacing="0" cellpadding="0">
		...
		<form method="post" name="reply_form" action="reply.jsp">
			...
			<tr>
				...
				<td width=180 bgcolor=ffffff>&nbsp;<input type="text"
					name="name" size=20></td>
				<td width=100 align=center bgcolor="#7eaee9">비밀번호</td>
				<td width=160 bgcolor=ffffff>&nbsp;<input type="password"
					name="pwd" size=15 value=""></td>
			</tr>
			<tr>
				<td width=110 align=center bgcolor="#7eaee9">E-mail 주소</td>
				<td colspan=3 bgcolor=ffffff>&nbsp;<input type="text" size=30
					name="email" value=""></td>
			</tr>
			<tr>
				<td align=center bgcolor="#7eaee9">제 목</td>
				<td colspan=3 bgcolor=ffffff>&nbsp;<input type="text" size=40
					name="title" value="<%="[답변] " + b_title%>"></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan=4 align=right height=25><a
					href="javascript:go_reply()"><img src="img/b_reply.gif"
						border=0></a> <a href="javascript:history.go(-1)"><img
						src="img/b_cancel.gif" border=0></a></td>
			</TR>
		</form>
		</TD>
		</TR>
